...
public class WscargaMasivaImagenesLocator extends org.apache.axis.client.Service implements co.com.metrocuadrado.webservice.client.WscargaMasivaImagenes {
    ...
    public co.com.metrocuadrado.webservice.client.WscargaMasivaImagenesSoap getWscargaMasivaImagenesSoap() throws javax.xml.rpc.ServiceException {
    ...
    public co.com.metrocuadrado.webservice.client.WscargaMasivaImagenesSoap getWscargaMasivaImagenesSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            co.com.metrocuadrado.webservice.client.WscargaMasivaImagenesSoapStub _stub = new co.com.metrocuadrado.webservice.client.WscargaMasivaImagenesSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (co.com.metrocuadrado.webservice.client.WscargaMasivaImagenesSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                co.com.metrocuadrado.webservice.client.WscargaMasivaImagenesSoapStub _stub = new co.com.metrocuadrado.webservice.client.WscargaMasivaImagenesSoapStub(new java.net.URL(WscargaMasivaImagenesSoap_address), this);
                _stub.setPortName(getWscargaMasivaImagenesSoapWSDDServiceName());
                return _stub;
            }
        }
